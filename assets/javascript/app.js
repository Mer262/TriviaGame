...
$(document).ready(function() {
    ...
    function displayDiv() {
        ...
        for (var i = 0; i < questions.length; i++) {
            ...
            thisQuestion = questions[i].question;
            storeAnswer = questions[i].answer;
            console.log("The storeAnswer is " + storeAnswer);
            answered = "option-" + questions[i].answer;
            console.log("Answer is: " + answered)
            birdPhoto = questions[i].img;
            console.log("birdPhoto: " + birdPhoto);
            answerDisplay = questions[i].choices[storeAnswer];
            ...
            $(".choice").click(function(event) {
                ...
                if (getId == answered) {
                    ...
                    $("#hiddenDiv").text("That's correct! The answer was " + answerDisplay + ".");
                    numberCorrect++;
                    ...
                    $("#hiddenDiv").text("Sorry! The correct answer was " + answerDisplay + ".");
                    numberIncorrect++;
